...
public class ShotgunShellEntity extends ThrownItemEntity {
    public ShotgunShellEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }
    public ShotgunShellEntity(World world, LivingEntity owner){
        super(XTech.BulletEntityTypeShell,owner,world);
        player =owner;
    }
    public ShotgunShellEntity(World world, double x, double y, double z){
        super(XTech.BulletEntityTypeShell,x,y,z,world);
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) { // called on entity hit.
        ...
        if(player instanceof PlayerEntity playerEntity) {
            ...
            float formula = (float) (30f - (distancex_z + distancey)/1.5);

            float formula2 = (float) (30f - distancex_z/1.5);
            if (entity instanceof PlayerEntity pe && pe.getActiveItem().isOf(Items.SHIELD)) {
                ...
                pe.getActiveItem().setDamage(+100);
            } else {
